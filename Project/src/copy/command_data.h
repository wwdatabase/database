...
public:
    ...
    int insertData(string db, string attrName[], string attrData[], int num)
    {
    ...
    void deleteData(string db, int page[], int position[], int num)
    {
        DB_File* chart = new DB_File();
        chart->openFile(db.c_str());
        chart->resetKeys();
    ...
    bool updateData(string db, int page[], int position[], string attrName[], string attrData[], int attrNull[], int num_attr, int num_data)
    {
        DB_File* chart = new DB_File();
        chart->openFile(db.c_str());
        chart->resetKeys();
    ...
    string selectColumn(string db, string attrName[], int attrNum, int page[], int position[], int dataNum)
    {
        char nn[20] = {};
